...
public partial class GameEntity {
    ...
    public Code.Gameplay.Common.Visuals.WorldPosition worldPosition { get { return (Code.Gameplay.Common.Visuals.WorldPosition)GetComponent(GameComponentsLookup.WorldPosition); } }
    ...
    public GameEntity AddWorldPosition(UnityEngine.Vector3 newValue) {
        ...
        var component = (Code.Gameplay.Common.Visuals.WorldPosition)CreateComponent(index, typeof(Code.Gameplay.Common.Visuals.WorldPosition));
